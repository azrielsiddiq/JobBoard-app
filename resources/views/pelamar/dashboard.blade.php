...
<x-nav-pelamar>
    ...
    <section class="relative bg-[#fafafa] py-28 overflow-hidden">
        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-[40rem] h-[40rem] bg-purple-300 rounded-full blur-[160px] opacity-20 -z-10"></div>
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h1 class="text-5xl font-extrabold text-gray-900 leading-tight">
                Bekerja di <span class="text-purple-600">PT YouthWare</span>
            </h1>
    ...
    <section class="bg-white py-20 border-b border-gray-100">
        <div class="max-w-5xl mx-auto px-6 text-center">
            ...
            <p class="text-gray-600 text-base leading-relaxed">
                PT YouthWare Indonesia adalah perusahaan teknologi yang berfokus pada pengembangan solusi digital kreatif untuk generasi muda. Kami menggabungkan semangat anak muda dengan teknologi untuk menciptakan inovasi yang berdampak.
            </p>
        </div>
    </section>
    ...
    @forelse ($lowongans as $lowongan)
        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-md hover:shadow-lg transition flex flex-col gap-5">
            
            <!-- Bagian Atas -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 bg-purple-100 text-purple-600 flex items-center justify-center rounded-xl text-xl sm:text-2xl font-bold">
